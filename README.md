...
Проблема: SELinux-контекст директории был сохранён некорректно (`default_t` / `unlabeled_t`). Из-за этого в чистом варианте проверка web-сервера не могла пройти.
